                ...
                <div class="p-6 bg-white border-b border-gray-200">
                     ...
                     <div class="form-group">
                        ...
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                         ...
                         {!! Form::text('descripcion', null, ['class'=>"appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3", 'placeholder'=>'Correr encima de una cinta']) !!}
                         </div>
                    ...
                    {!! Form::submit('Crear actividad', ['class'=>"border border-red-500 text-red-500 rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:text-white hover:bg-red-600 focus:outline-none focus:shadow-outline"]) !!}
                     {!! Form::close() !!}
                </div>
            </div>
        </div>
